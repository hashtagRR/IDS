...
#Base
clf_b = xgb.XGBClassifier(n_jobs=8)

sclf = StackingClassifier(classifiers=[clf_1, clf_2, clf_3], meta_classifier=clf_b).fit(x_train, y_train)
...
evaluation(y_test, y_pred_sclf, type)
